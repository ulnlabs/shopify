            ...
            <div className="h-fit">
                  ...
                  <main className="flex justify-center">
                        <section className="w-[95%] border rounded-xl mt-36 shadow-[rgba(50,50,93,0.25)_0px_6px_4px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px]">
                              ...
                              <div className="">
                                    <form action="" onSubmit={handleSubmit} className="min-h-[200px] grid  grid-row-2 grid-cols-12   p-3">
                                          <div className="row-start-1 md:gap-x-3 md:items-center md:grid md:grid-cols-12 col-start-2 grid col-span-10">
                                                <label htmlFor="name" className=" md:col-span-4 md:text-end ">Category Name<span className='text-red-400'>*</span>:</label>
                                                <input type="text"
                                                      name="name"
                                                      id="name"
                                                      onChange={(e) =>
                                          ...
                                          <div className="row-start-2 md:gap-x-3 md:items-center md:grid md:grid-cols-12 col-start-2 grid col-span-10">
                                                <label  className=" md:col-span-4 md:text-end" htmlFor="description">Description :</label>
                                                <input type="textarea"
                                                      name="description"
                                                      id="description"
                                                      onChange={(e) =>
